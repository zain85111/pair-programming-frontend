...
export const Login = () => {
    return (
        <div className='d-flex justify-content-start h-75 loginpage'>
            ...
            <div className="form-section col d-flex flex-column justify-content-evenly align-items-center">
                <div>
                    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQyFzSDeCJ7jEOCJceGOu897ZOpsNDL_b09sKadR1RpwOyP0Nv6p165vLu2Ocn9DYao2S8&usqp=CAU" alt="" className="img-fluid login-img" />
                </div>
